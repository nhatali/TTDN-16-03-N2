...
[![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=for-th…ck)](https://developer.mozilla.org/en-US/docs/Web/JavaScript)
[![XML](https://img.shields.io/badge/XML-FF6600?style=for-the-badge&logo=codeforces&logoColor=white)](https://www.w3.org/XML/)
### Cơ sở dữ liệu
[![PostgreSQL](https://img.shields.io/badge/PostgreSQL-316192?style=for-th…ogo=postgresql&logoColor=white)](https://www.postgresql.org/)
</div>
...
#### 3.1.1. Tải project.
```
git clone  https://gitlab.com/anhlta/odoo-fitdnu.git checkout
```
