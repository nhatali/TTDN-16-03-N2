odoo.define('web.BasicView', function (require) {
    ...
    var BasicView = AbstractView.extend({
        ...
        init: function (viewInfo, params) {
            ...
            this.fieldsInfo = {};
            this.fieldsInfo[this.viewType] = this.fieldsView.fieldsInfo ? this.fieldsView.fieldsInfo[this.viewType] : {};
            ...
            this.loadParams.limit = this.arch && this.arch.attrs ? parseInt(this.arch.attrs.limit, 10) || params.limit : params.limit;
